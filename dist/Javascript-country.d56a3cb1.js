...
fetch(api_url).then((response)=>{
    ...
    const displayCountry = (countrys)=>{
        countryList.innerHTML = countrys.map((countrys)=>{
            return `
            <li class="country">
            <img src="${countrys.flag}" style="width: 50px; padding-top: 20px; row-gap: 20px">
                ...
                <p>${countrys.name} is situated in ${countrys.region} It has a population of ${countrys.population} people.
                 The capital is ${countrys.capital} and you can pay with ${countrys.currencies}</p>
            </li>
                `;
        }).join('');
    };
...
//# sourceMappingURL=Javascript-country.d56a3cb1.js.map
